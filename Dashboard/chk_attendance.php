    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="table-data">
                <div class="order">
                    <div class="head">
                        <h3>Check Student Attendence</h3>
            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header">
                        <h4>Student Attendance Information</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-7">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM std_attendance WHERE CONCAT(name,stdId,cellNo,program,date,present) LIKE '%$filtervalues%' ";
