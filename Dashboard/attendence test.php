...
<table width="800" border="1" align="center">
      <tr>
        <td><center> <h1>Added Student Attendence</h1></center></td>
      </tr>
      ...
      <tr>
        ...
        <table width="160px" align="left" style="">
          ...
          <table width="400" border="3" align="left" style="margin-left:20px;">
            ...
            <tr bgcolor="#999966">
              <td width="114"><span class="style7">Student Id</span></td>
     ...
     if(!$conn){
        ...
        extract($_POST);
        $query = "select *from `std_add` order by `id`";
        $s = 0;
        ...
        while($rec = mysqli_fetch_array($result))
        {
          ...
          echo ' <tr>
                ...
                <input type="hidden" name="stdId" value='.$rec["stdId"].' >
